"""
Django settings for sales_admin project.
...
SECRET_KEY = 'django-insecure-1+f*2prsjvgxmkz8z*3z(gjm64!4cyn+$o3sd^l&_*d_!)*1+d'
...
CORS_ORIGIN_WHITELIST = (
    'http://localhost:3000', # frontend app (react)
    'http://localhost:8000'
)

ROOT_URLCONF = 'sales_admin.urls'
...
WSGI_APPLICATION = 'sales_admin.wsgi.application'
